...
@"_SM33scala.concurrent.ExecutionContextG4type" = hidden global { ptr, i32, i32, ptr } { ptr @"_SM15java.lang.ClassG4type", i32 -82, i32 -1, ptr @"_SM7__constG1-1" }
@"_SM41scala.concurrent.ExecutionContextExecutorG4type" = hidden global { ptr, i32, i32, ptr } { ptr @"_SM15java.lang.ClassG4type", i32 -120, i32 -1, ptr @"_SM7__constG1-3" }
